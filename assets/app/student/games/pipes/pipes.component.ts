...
export class PipesComponent implements AfterViewInit{
  ...
  private gameBoard = [];
  private cornerOuterImg = require('../../../assets/games/pipes/corner_outer.png');
  private cornerUnderImg = require('../../../assets/games/pipes/corner_under.png');
  private straightOuterImg = require('../../../assets/games/pipes/straight_outer.png');
  private straightUnderImg = require('../../../assets/games/pipes/straight_under.png');
  private cornerFullImg1 = require('../../../assets/games/pipes/corner_full1.png');
  private cornerFullImg2 = require('../../../assets/games/pipes/corner_full2.png');
  private cornerFullImg3 = require('../../../assets/games/pipes/corner_full3.png');
  private cornerFullImg4 = require('../../../assets/games/pipes/corner_full4.png');
  private straightFullImg1 = require('../../../assets/games/pipes/straight_full1.png');
  private straightFullImg2 = require('../../../assets/games/pipes/straight_full2.png');
  private endUnderImg = require('../../../assets/games/pipes/end_pipe_under.png');
  private endOuterImg = require('../../../assets/games/pipes/end_pipe_outer.png');
  private waterSpillImg = require('../../../assets/games/pipes/waterSpill.png');
  private acidSpillImg = require('../../../assets/games/pipes/acidSpill.png');
  private terrains = [ require('../../../assets/games/pipes/terrain_1.jpg'), require('../../../assets/games/pipes/terrain_2.jpg'), require('../../../assets/games/pipes/terrain_3.jpg'), require('../../../assets/games/pipes/terrain_4.jpg'), require('../../../assets/games/pipes/terrain_5.jpg') ] ;
  private terrainsGrass = [ require('../../../assets/games/pipes/terrain_grass_1.jpg'), require('../../../assets/games/pipes/terrain_grass_2.jpg'), require('../../../assets/games/pipes/terrain_grass_3.jpg')]
  private rotations = [ 'rotate(0deg)', 'rotate(90deg)', 'rotate(180deg)', 'rotate(270deg)'];
  private rocks = [ require('../../../assets/games/pipes/rock1.png'), require('../../../assets/games/pipes/rock2.png'), require('../../../assets/games/pipes/rock3.png')];
  private bubbles = [ require('../../../assets/games/pipes/bubbles_1.png'), require('../../../assets/games/pipes/bubbles_2.png'), require('../../../assets/games/pipes/bubbles_3.png') ];
  ...
  private pipes = [ 
   ...
   constructor( private renderer: Renderer, private arrayService: ArrayService, private apiService: ApiService, private route: ActivatedRoute ){
    this.gameType = this.route.params.value.type;
